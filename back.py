...
@app.route('/categories/<category_name>/acts', methods=['GET'])
...
@app.route('/acts/<act_id>', methods=['DELETE'])
...
@app.route('/acts/upvote',methods=['POST'])
...
@app.route('/categories/<category_name>/acts/size',methods=['GET'])
